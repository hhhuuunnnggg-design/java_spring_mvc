...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid page-header py-5">
      <h1 class="text-center text-white display-6">Laptop</h1>
            ...
            <div class="bg-light rounded">
              <div class="p-4">
                <h1 class="display-6 mb-4">
                  Thong tin <span class="fw-normal">Don hang</span>
                </h1>
                <div class="d-flex justify-content-between mb-4">
                  <h5 class="mb-0 me-4">Tạm tính:</h5>
                  <p
                    class="mb-0 cart-total-price"
              ...
              >
                <h5 class="mb-0 ps-4 me-4">tong tien</h5>
